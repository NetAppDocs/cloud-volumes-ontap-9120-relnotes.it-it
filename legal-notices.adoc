...
* link:media/notice-aws.pdf["Avviso per il mediatore Cloud Volumes ONTAP 9.12.0 in AWS"^]
* link:media/notice-google-cloud.pdf["Avviso per Cloud Volumes ONTAP 9.12.0 mediator in Google Cloud"^]
